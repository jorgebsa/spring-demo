...
in the following sections. If you need further help, check its [documentation](https://docs.gradle.org/current/userguide/userguide.html)
...
Gradle's [toolchain](https://docs.gradle.org/current/userguide/toolchains.html) concept is 
...
from a specific vendor, you can do so by setting the [vendor property](https://docs.gradle.org/current/userguide/toolchains.html#sec:vendors)
...
generate these reports, the [JaCoCo Gradle plugin](https://docs.gradle.org/current/userguide/jacoco_plugin.html) 
...
Is as easy as invoking a simple [task](https://docs.spring.io/spring-boot/docs/current/gradle-plugin/reference/htmlsingle/#running-your-application)
