...
in the following sections. If you need further help, check its [documentation](https://docs.gradle.org/7.3/userguide/userguide.html)
...
Gradle's [toolchain](https://docs.gradle.org/7.3/userguide/toolchains.html) concept is 
...
from a specific vendor, you can do so by setting the [vendor property](https://docs.gradle.org/7.3/userguide/toolchains.html#sec:vendors)
...
generate these reports, the [JaCoCo Gradle plugin](https://docs.gradle.org/7.3/userguide/jacoco_plugin.html) 
...
* You can run it using the [Spring Boot Gradle plugin](https://docs.spring.io/spring-boot/docs/2.5.6/gradle-plugin/reference/htmlsingle/#running-your-application)

### Running the application with Gradle
 
Is as easy as invoking a simple [task](https://docs.spring.io/spring-boot/docs/2.5.6/gradle-plugin/reference/htmlsingle/#running-your-application)
